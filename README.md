...
Análisis de regresión en R del World Happiness Report 2019 pre-COVID. Destaca por la selección de características (AIC), diagnóstico de supuestos (Kolmogorov-Smirnov, Durbin-Watson) y manejo iterativo de outliers. Logra un R^2 ajustado de 0.8352, demostrando rigor analítico.
